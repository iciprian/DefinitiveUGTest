...
for root, dirs, files in os.walk('/home/icipriano/DefinitiveUGTest/UG_Conversion_Data/OmpWcmp_Feb9'):
    for file in files:
        if file.endswith('.stats'):
            ...
            T.append(L)
df = pd.DataFrame(columns=('INSTANCE','BZ_NITERATIONS','BZ_SOLVETIME','LZ_UBOUND','BZ_LBOUND','TOPOSORT_OBJVAL'))
